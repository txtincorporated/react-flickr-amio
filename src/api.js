export const FLICKR_KEY = '49ab98f0131176cf7168bf57ca213ff9';
// const FLICKR_SECRET = 'a475bf30b9544209';

export const FLICKR = 'https://api.flickr.com/services/rest';
...
export const apiParams = `${FLICKR}/?method=flickr.photos.search&api_key=${FLICKR_KEY}&tags=landscape%2C+architecture&min_upload_date=${startDate}&sort=date-upload-asc&safe_search=1&content_type=1&media=photos&has_geo=1&extras=geo&per_page=250&format=json&nojsoncallback=1`;
